...
data_path = '/home/hunter/Self-Driving-Car/data'  #change this also data foler should have eveything
data_folders = os.listdir(data_path)
folder = sanitize_data_folders(data_folders)
